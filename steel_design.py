...
Mservice_factor = pn.widgets.FloatInput(name='Mservice / Mn_MIN', start=0.0, end=1.0, step=0.05, value=0.5, width=285)

Mminor_ratio = pn.widgets.FloatInput(name='Mry / Mcy', start=0.0, end=1.0, step=0.01, value=0.0, width=570)
